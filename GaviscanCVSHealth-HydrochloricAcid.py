...
BASE = "GavisconCVSHealth dissociation"
...
def main():
    ph_graph = LinearGraph("Initial concentration of Base in GavisconCVSHealth (mol/L)", "pH", "")
    change_graph = LinearGraph("Concentration of Base in GavisconCVSHealth added (mol/L)", "Change in Concentration (mol/L)", "Reaction")
    ...
    plt.ylim(0, 14)
    ph_graph.graph(title="pH as GavisconCVSHealth is added to 0.1M Hydrochloric Acid")
