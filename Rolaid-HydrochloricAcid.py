...
def main():
    ph_graph = LinearGraph("Initial concentration of Base in Rolaid (mol/L)", "pH", "")
    change_graph = LinearGraph("Concentration of Base in Rolaid added (mol/L)", "Change in Concentration (mol/L)", "Reaction")
    ...
    plt.ylim(0, 14)
    ph_graph.graph(title="pH as Rolaid is added to 0.1M Hydrochloric Acid")
