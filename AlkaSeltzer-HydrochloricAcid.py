...
BASE = "Alka-Seltzer dissociation"
...
def main():
    ph_graph = LinearGraph("Initial concentration of Base in Alka-Seltzer (mol/L)", "pH", "")
    change_graph = LinearGraph("Concentration of Base in Alka-Seltzer added (mol/L)", "Change in Concentration (mol/L)", "Reaction")
    ...
    plt.ylim(0, 14)
    ph_graph.graph(title="pH as Alka-Seltzer is added to 0.1M Hydrochloric Acid")
